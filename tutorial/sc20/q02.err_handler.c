...
/* This program handles errors in an error handler, no need to check 
 * the return code of all MPI functions. Neat!. 
 *
 * Can you also make it print which ranks have caused the operation to
 * raise an error?
 */
